...
class PodcastGenreTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Media::updateImageFromURL($genre_2, public_path('storage/defaults/images/podcast_genres/podcast-news.png'), 'cover');
        ...
        Media::updateImageFromURL($genre_3, public_path('storage/defaults/images/podcast_genres/podcast-art.png'), 'cover');

        $genre_4 = PodcastGenre::create([
            'name' => 'Gaming',
            'slug' => 'gaming',              
        ]);
        Media::updateImageFromURL($genre_4, public_path('storage/defaults/images/podcast_genres/podcast-gaming.png'), 'cover');
        ...
        Media::updateImageFromURL($genre_5, public_path('storage/defaults/images/podcast_genres/podcast-education.png'), 'cover');
        ...
        Media::updateImageFromURL($genre_6, public_path('storage/defaults/images/podcast_genres/podcast-comedy.png'), 'cover');
        ...
        Media::updateImageFromURL($genre_7, public_path('storage/defaults/images/podcast_genres/podcast-health.png'), 'cover');
        ...
        Media::updateImageFromURL($genre_8, public_path('storage/defaults/images/podcast_genres/podcast-fiction.png'), 'cover');
        ...
        Media::updateImageFromURL($genre_9, public_path('storage/defaults/images/podcast_genres/podcast-sports.png'), 'cover');
        ...
        Media::updateImageFromURL($genre_10, public_path('storage/defaults/images/podcast_genres/podcast-technology.png'), 'cover');
        ...
        Media::updateImageFromURL($genre_11, public_path('storage/defaults/images/podcast_genres/podcast-science.png'), 'cover');
    }
}
